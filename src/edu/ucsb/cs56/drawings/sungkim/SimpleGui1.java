package edu.ucsb.cs56.drawings.sungkim;
...
/** SimpleGui1 comes from Head First Java 2nd Edition p. 355.
    ...
    @author S. Kim (who only edited the text and changed the background color)
...
public class SimpleGui1 {
    ...
    */
	...
	java.awt.Color myColor = new java.awt.Color(120,164,32);   // R, G, B values.
