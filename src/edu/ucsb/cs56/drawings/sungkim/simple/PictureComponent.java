package edu.ucsb.cs56.drawings.sungkim.simple;
...
/**
   ...
   and has a correction by Sung Kim

   @author Phill Conrad (original drawing)
   @author Sung Kim (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("A beautiful snowman, by Sung Kim", 20,20);
