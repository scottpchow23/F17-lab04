package edu.ucsb.cs56.drawings.efreilafert.simple;
...
/**
   ...
   @author @@@ Eric Freilafert(fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Made a cute snowman - Eric Freilafert", 20,20);
